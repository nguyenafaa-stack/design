...
// Link ảnh mockup ly trắng (Bạn nên thay bằng link ảnh của bạn để ổn định hơn)
...
// // Component hỗ trợ load ảnh từ URL/Base64
// const ImageLayer = ({ url, x, y, width, height }) => {
//   const [image] = useImage(url, "Anonymous");
//   if (!image) return null;

//   // Tính toán để ảnh giữ đúng tỷ lệ (Object-fit: contain)
...
//     <Image
//       image={image}
//       x={x + (width - newWidth) / 2} // Căn giữa theo chiều ngang
//       y={y + (height - newHeight) / 2} // Căn giữa theo chiều dọc
//       width={newWidth}
//       height={newHeight}
//     />
//   );
...
//   const [userImage, setUserImage] = useState(null); // Lưu URL ảnh đã upload
...
//       reader.onload = () => {
//         setUserImage(reader.result); // Lưu chuỗi base64 của ảnh
//       };
...
//     const uri = stageRef.current.toDataURL({ pixelRatio: 3 });
//     const link = document.createElement("a");
//     link.download = `custom-mug-${Date.now()}.png`;
//     link.href = uri;
//     link.click();
//   };
...
//         {/* UPLOAD FILE */}
//         <div style={styles.inputGroup}>
//           <label style={styles.label}>UPLOAD YOUR PHOTO</label>
//           <button
//             onClick={() => fileInputRef.current.click()}
//             style={styles.uploadBtn}
//           >
//             {userImage ? "Change Photo" : "Select Image"}
//           </button>
//           <input
//             type="file"
//             ref={fileInputRef}
...
//         {/* NÚT DOWNLOAD */}
//         <button onClick={handleExport} style={styles.downloadBtn}>
//           <span>⬇</span> Download Print File
//         </button>
//       </div>
...
//           <span style={{ fontWeight: "bold" }}>Mockup Preview</span>
...
//               {/* 2. Vùng thiết kế của người dùng */}
//               <Group x={195} y={160}>
//                 {/* Hiển thị ảnh upload hoặc placeholder nếu chưa có ảnh */}
//                 {userImage ? (
//                   <ImageLayer
//                     url={userImage}
//                     x={0}
